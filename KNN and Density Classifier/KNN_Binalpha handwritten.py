...
# # 1 import images
dataFile1 = 'D:/! ZhouHuiz/CUHK-FE/5310 MLearning/proj1/Binalpha handwritten/trainX.mat'
data1 = scio.loadmat(dataFile1)
trainX = data1['trainX'].transpose()

dataFile2 = 'D:/! ZhouHuiz/CUHK-FE/5310 MLearning/proj1/Binalpha handwritten/trainY.mat'
data2 = scio.loadmat(dataFile2)
trainY = data2['trainY'][0,:]

dataFile3 = 'D:/! ZhouHuiz/CUHK-FE/5310 MLearning/proj1/Binalpha handwritten/testX.mat'
data3 = scio.loadmat(dataFile3)
testX = data3['testX'].transpose()

dataFile4 = 'D:/! ZhouHuiz/CUHK-FE/5310 MLearning/proj1/Binalpha handwritten/testY.mat'
